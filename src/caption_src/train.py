...
def distributed_train(rank,
    ...
    if train_args.reinforce:
        ...
        data_loader = CocoDataLoader(coco_dataset,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_parallel_batch_size', type=int, default=12)
    ...
    parser.add_argument('--captions_path', type=str, default='/data/jaeyeong/dacon/Image_Quality_Assessment/exv2/ExpansionNet_v2/github_ignore_material/raw_data/')
    parser.add_argument('--partial_load', type=str2bool, default=False)
    parser.add_argument('--backbone_save_path', type=str, default='/data/jaeyeong/dacon/Image_Quality_Assessment/ExpansionNet_v2/pretrained_weight/xe_model.pth')
    parser.add_argument('--body_save_path', type=str, default='/data/jaeyeong/dacon/Image_Quality_Assessment/ExpansionNet_v2/pretrained_weight/xe_model.pth')
    ...
    coco_dataset = CocoDatasetKarpathy(
        ...
        annotations_path=path_args.captions_path + "train.json",
...
#     --reinforce False --num_epochs 8 &> output_file_train.txt &
