...
# model_dir = "/data/jaeyeong/dacon/Image_Quality_Assessment/IQA/nfnet_pretrained/f5_weight.npz"
model_dir = None

# save_dir = "./nfnet_f5_test_features_flip.pkl"
save_dir = None
