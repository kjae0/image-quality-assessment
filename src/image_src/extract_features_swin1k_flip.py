...
# model_dir = "/data/jaeyeong/dacon/Image_Quality_Assessment/IQA/swinv2_pretrained/swinv2_L_1k.pth"
model_dir = None

# save_dir = "./swinv2_l_1k_train_features_flip.pkl"
save_dir = None
...
model = SwinTransformerV2(img_size=384, window_size=24, embed_dim=192, num_classes=1000)
